...
RESULT_FILE_NAME = 'full_test_two.xlsx'
...
ref_raw = pd.read_csv(REF_FILE_NAME, index_col=False, usecols={"Start", "Peptide"})
test_raw = pd.read_csv(TEST_FILE_NAME, index_col=False, usecols={"Start", "Peptide"})
main_raw = pd.read_csv(MAIN_FILE_NAME, index_col=False, skiprows=1, usecols={"Starting Position", "Description"})
